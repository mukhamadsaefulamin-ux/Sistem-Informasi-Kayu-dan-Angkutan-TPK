...
const chartsSectionStart = code.indexOf('{/* Visual Interactive Charts */}');

if (sisaSectionStart === -1 || chartsSectionStart === -1) {
...
code = code.substring(0, sisaSectionStart) + newSisaSection + code.substring(chartsSectionStart);
